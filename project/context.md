...
- **Languages**: python: 343, md: 67, yaml: 42, txt: 8, shell: 7
- **Analysis Mode**: static
- **Total Functions**: 3679
- **Total Classes**: 250
- **Modules**: 489
- **Entry Points**: 0
...
- **Functions**: 20
- **Classes**: 5
- **File**: `COMPARISON_AND_OPTIMIZATION.md`
...
### SUMD.parse_evolution_metrics

### SUMD._generate_format_outputs

### SUMD.evaluate_format

### SUMD.ast_unparse

### SUMD.validate_and_setup

### SUMD.validate_chunked_output

### SUMD._validate_chunks

### SUMD._validate_single_chunk

### SUMD._export_simple_formats

### SUMD._export_calls_format

### SUMD._expand_all_formats

### SUMD._export_registry_formats

### SUMD._get_format_kwargs

### SUMD._process_subproject
...
### SUMD._process_decorators

### SUMD._process_classes
